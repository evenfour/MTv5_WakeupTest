...
typedef struct
{
  ...
  uint32_t FSMC_MemoryType;          /*!< Specifies the type of external memory attached to
                                          ...
                                          This parameter can be a value of @ref FSMC_EF_spiFlashType */
...
#define IS_FSMC_EF_spiFlashWIDTH(WIDTH) (((WIDTH) == FSMC_MemoryDataWidth_8b) || \
